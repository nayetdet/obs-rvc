...
enum rvc_ipc_status rvc_ipc_configure(rvc_ipc_t *context, const rvc_settings_request_t *request, rvc_settings_response_t *response, uint32_t timeout_ms);
enum rvc_ipc_status rvc_ipc_convert(rvc_ipc_t *context, const rvc_audio_request_t *request, rvc_audio_response_t *response, uint32_t timeout_ms);
